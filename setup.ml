...
(* OASIS_START *)
(* DO NOT EDIT (digest: 6f3db56508299cf9c65b25170be21da0) *)
(*
...
let setup_t =
  {
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage
                             ("cohttp.lwt",
                               Some (OASISVersion.VGreaterEqual "0.9.1"))
                        ];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\159ô£QS\025ï\155ùmK\147l¥\138a";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
