...
(* OASIS_START *)
(* DO NOT EDIT (digest: 13b5f27c00f90d5447eebc55c043466d) *)
(*
...
# 21 "/Users/avsm/.opam/system/build/oasis.0.3.0/src/plugins/custom/CustomPlugin.ml"
...
let setup_t =
  {
     ...
     test =
       [
          ("lwt_json_logger_test",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$Lwt_json_logger_test", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)];
                 })
       ];
     doc = [("Lwt_json_logger", OCamlbuildDocPlugin.doc_build "lib")];
     ...
     clean_doc = [("Lwt_json_logger", OCamlbuildDocPlugin.doc_clean "lib")];
     distclean = [];
     distclean_test =
       [
          ("lwt_json_logger_test",
          ...
          conf_custom =
            {
               ...
               post_command =
                 [(OASISExpr.EBool true, Some (("./crunch.sh", [])))];
               };
               ...
               post_command =
                 [
                    (OASISExpr.EBool true,
                      Some (("$rm", ["-f"; "lib/lwt_json_logger_files.ml"])))
                 ];
               };
          files_ab = [];
          sections =
            [
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           FindlibPackage
                             ("cohttp.lwt",
                               Some (OASISVersion.VGreaterEqual "0.9.2"));
                   ...
                   {
                      lib_modules =
                        ["Lwt_json_logger"; "Lwt_json_logger_files"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "lwt-json-logger";
                      lib_findlib_containers = [];
                      });
               Executable
                 ({
                     cs_name = "Lwt_json_logger_test";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
                      ...
                      bs_build_depends = [InternalLibrary "Lwt_json_logger"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {
                      exec_custom = true;
                      exec_main_is = "lwt_json_logger_test.ml";
                      });
               Doc
                 ({
                     cs_name = "Lwt_json_logger";
                     ...
                     },
                   {
                      ...
                      doc_title = "Lwt_json_logger docs";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "M \015û D°æßX\026\004~T\136Ó";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
